...
class RadialOrange extends StatelessWidget {
  const RadialOrange({Key? key}) : super(key: key);
...
class RPSCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint0Fill.shader =
      ...
      const Color(0xffFFD600).withOpacity(0.43),
      const Color(0xffFFD600).withOpacity(0)
    ], [
      0,
      1
    ]);
