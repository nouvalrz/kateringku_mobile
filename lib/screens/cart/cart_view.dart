...
class OrderTile extends StatelessWidget {
  int index;
  OrderTile({Key? key, required this.index}) : super(key: key);
    ...
    return GestureDetector(
      onLongPress: () {
        Get.defaultDialog(
            textConfirm: "Hapus",
            textCancel: "Batal",
            middleTextStyle: AppTheme.textTheme.titleLarge!.copyWith(
                fontSize: 14,
                fontWeight: FontWeight.w500,
                color: Colors.grey[700]),
            middleText: "Yakin menghapus cart?",
            radius: 8,
            onConfirm: () async {
                ...
                Row(
                  ...
                  children: [
                    Container(
                      child: Column(
                        children: [
                          cartController.carts[index].orderType == "PREORDER"
                              ? PreOrderBadge()
                              : LanggananBadge(),
                          SizedBox(
                            height: 12,
                            ...
                            children: [
                              Text(
                                  CurrencyFormat.convertToIdr(
                                      cartController.carts[index].totalPrice(),
                                      0),
                                  style: AppTheme.textTheme.titleLarge!
                                      .copyWith(
                                          ...
                                          fontWeight: FontWeight.w500)),
                              Text(
                                  "${cartController.carts[index].totalQuantity()} Item",
                                  style: AppTheme.textTheme.titleLarge!
                                      .copyWith(
                                          fontSize: 12,
                  ...
                  children: [
                    Column(
                      children: List.generate(
                          cartController.carts[index].cartDetails!.length,
                          (index2) => Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                            "${cartController.carts[index].cartDetails![index2].product!.name} x${cartController.carts[index].cartDetails![index2].quantity}",
                                            style: AppTheme
                      ...
                      child: Row(
                        children: [
                          GestureDetector(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                var cateringDisplayModel = CateringDisplayModel(
                                    image: cartController
                                        .carts[index].catering!.image!,
                                    name: cartController
                                        .carts[index].catering!.name!,
                                    categories: cartController
                                        .carts[index].catering!.categories,
                                    village: cartController
                                        .carts[index].catering!.village,
                                    id: cartController
                                        .carts[index].cateringId!);
                                Get.toNamed(
                                    RouteHelper.getCatering(
                                        catering_name: cartController
                                            .carts[index].catering!.name!,
                                        catering_image: cartController
                                            .carts[index].catering!.image!,
                                        catering_location: cartController
                                            .carts[index]
                                            .catering!
                                            .village!
                                            .name!,
                                        catering_id: cartController
                                            .carts[index].cateringId!
                                            .toString(),
                                        catering_latitude: double.parse(
                                            cartController.carts[index]
                                                .catering!.latitude!),
                                        catering_longitude: double.parse(
                                            cartController.carts[index]
                                                .catering!.longitude!),
                                        fromCart: "true"),
                                    arguments: [
...
class PreOrderBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: AppTheme.primaryGreen, borderRadius: BorderRadius.circular(6)),
    );
  }
}
